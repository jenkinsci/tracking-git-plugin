...
public class TestGitRepo {
	...
	public final PersonIdent johnDoe = new PersonIdent("John Doe",
			"john@doe.com");
	public final PersonIdent janeDoe = new PersonIdent("Jane Doe",
			"jane@doe.com");

	public TestGitRepo(String name, HudsonTestCase forTest,
	...
	public void commit(final String fileName, final PersonIdent committer,
	...
	public void commit(final String fileName, final PersonIdent author,
